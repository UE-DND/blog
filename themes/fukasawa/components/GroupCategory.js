        ...
        return (
          <Link
            ...
            className={(selected
              ...
              : 'dark:text-gray-400 text-gray-500 hover:text-white hover:bg-gray-600 dark:hover:text-white') +
              '  text-sm w-full items-center duration-300 px-2 cursor-pointer py-1 font-bold rounded-lg'}>
