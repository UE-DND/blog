...
module.exports = {
  // START********代码相关********
  // PrismJs 代码相关
  PRISM_JS_PATH: '/js/libs/prismjs/components/',
  PRISM_JS_AUTO_LOADER: '/js/libs/prismjs/prism-autoloader.min.js',

  // 代码主题 @see https://github.com/PrismJS/prism-themes
  PRISM_THEME_PREFIX_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH ||
    '/css/prism-themes/prism-okaidia.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    '/css/prism-themes/prism-solarizedlight.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    '/css/prism-themes/prism-okaidia.min.css', // 深色模式主题
  ...
  MERMAID_CDN:
    ...
    '/js/libs/mermaid/mermaid.min.js' // 本地文件
